               ...
               bool is_min_truth = false, bool is_skip_delay_round = false, bool is_logic_sharing = false, bool is_dont_cares = false, bool is_verbose = false )
{
  ...
  assert( ntktype != lf::misc::E_LF_NTK_TYPE::E_LF_NTK_TYPE_LSILS_STRASH_AIG ||
          ...
          ntktype != lf::misc::E_LF_NTK_TYPE::E_LF_NTK_TYPE_LSILS_STRASH_AOG ntktype != lf::misc::E_LF_NTK_TYPE::E_LF_NTK_TYPE_LSILS_STRASH_XAG ||
  ...
  case lf::misc::E_LF_NTK_TYPE::E_LF_NTK_TYPE_LSILS_STRASH_OIG:
  {
    ...
    blut_seq_network netlist_asic = mockturtle::seq_map<lf::logic::lsils::oig_seq_network, 6u, mockturtle::cut_enumeration_tech_map_cut, 6u, mockturtle::classification_type::np_configurations>( ntk, techlib, ps );
    lfLmINST->set_current<blut_seq_network>( netlist_asic );
    break;
  }
  case lf::misc::E_LF_NTK_TYPE::E_LF_NTK_TYPE_LSILS_STRASH_AOG:
  {
    ...
    blut_seq_network netlist_asic = mockturtle::seq_map<lf::logic::lsils::aog_seq_network, 6u, mockturtle::cut_enumeration_tech_map_cut, 6u, mockturtle::classification_type::np_configurations>( ntk, techlib, ps );
    lfLmINST->set_current<blut_seq_network>( netlist_asic );
    break;
  }
  ...
  case lf::misc::E_LF_NTK_TYPE::E_LF_NTK_TYPE_LSILS_STRASH_XOG:
  {
    ...
    blut_seq_network netlist_asic = mockturtle::seq_map<lf::logic::lsils::xog_seq_network, 6u, mockturtle::cut_enumeration_tech_map_cut, 6u, mockturtle::classification_type::np_configurations>( ntk, techlib, ps );
    lfLmINST->set_current<blut_seq_network>( netlist_asic );
    break;
  }
