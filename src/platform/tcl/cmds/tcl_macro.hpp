...
#define LF_MACOR_REGISTER_TCL_CMD( type, cmd_name, anchor_domain )    \
  do                                                                  \
  {                                                                   \
    auto cmd_ptr = std::make_unique<type>( cmd_name, anchor_domain ); \
...
#define TCL_iEDA_INPUT_CONFIG "-input"
#define TCL_iEDA_OUTPUT_CONFIG "-output"
